...
batch_name = make_widget(widgets.Text(
    value='TimeToDisco',
    disabled=False
), "batch_name")

resume_run = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
), "resume_run", True)

run_to_resume = make_widget(widgets.Text(
    value='latest',
), "run_to_resume")

retain_overwritten_frames = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
...
intermediate_saves = make_widget(widgets.IntText(
    value=0,
), "intermediate_saves")

intermediates_in_subfolder = make_widget(widgets.Checkbox(
    value=True,
    indent=False,
), "intermediates_in_subfolder", True)

console_preview = make_widget(widgets.Checkbox(
    value=True,
    indent=False,
), "console_preview", True)

console_preview_width = make_widget(widgets.IntText(
    value=80,
), "console_preview_width")

display_rate = make_widget(widgets.IntText(
    value=50,
), "display_rate")

config_file = make_widget(widgets.Text(
    value=None,
), "config_file")

n_batches = make_widget(widgets.IntText(
    value=150,
), "n_batches")
...
init_image = make_widget(widgets.Text(
    value=None
), "init_image")

init_scale = make_widget(widgets.IntText(
    value=1000,
), "init_scale")

skip_steps = make_widget(widgets.IntText(
    value=0,
), "skip_steps")
...
init_generator = make_widget(widgets.Dropdown(
    options=['perlin', 'voronoi'],
    value='perlin',
    disabled=False,
), 'init_generator')

perlin_init = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
), "perlin_init", True)

perlin_mode = make_widget(widgets.Dropdown(
    options=["mixed", "color", "gray"],
    value='mixed',
), 'perlin_mode')

voronoi_points = make_widget(widgets.Dropdown(
    options=[20,50,100,150,250,500,1000],
    value=20,
), 'voronoi_points')

voronoi_palette = make_widget(widgets.Text(
    value='default.yaml'
), "voronoi_palette")

perlin_voronoi_tab = widgets.VBox([
    init_generator,
    perlin_init,
    perlin_mode,
    voronoi_points,
...
cutn_batches = make_widget(widgets.IntText(
    value=4,
), "cutn_batches")
clip_guidance_scale = make_widget(widgets.IntText(
    value=5000,
), "clip_guidance_scale")
cut_overview = make_widget(widgets.Text(
    value="[12]*400+[4]*600"
), "cut_overview")
cut_innercut = make_widget(widgets.Text(
    value="[4]*400+[12]*600"
), "cut_innercut")
cut_icgray_p = make_widget(widgets.Text(
    value="[0.2]*400+[0]*600"
), "cut_icgray_p")
cut_ic_pow = make_widget(widgets.FloatText(
    value=1,
), "cut_ic_pow")
eta = make_widget(widgets.FloatText(
    value=0.8,
), "eta")
clamp_max = make_widget(widgets.FloatText(
    value=0.05,
), "clamp_max")

rand_mag = make_widget(widgets.FloatText(
    value=0.05,
), "rand_mag")

tv_scale = make_widget(widgets.IntText(
    value=0,
), "tv_scale")

range_scale = make_widget(widgets.IntText(
    value=150,
), "range_scale")

sat_scale = make_widget(widgets.FloatText(
    value=0,
), "sat_scale")

clamp_grad = make_widget(widgets.Checkbox(
    value=True,
    indent=False,
), "clamp_grad", True)
clip_denoised = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
), "clip_denoised", True)
skip_augs = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
), "skip_augs", True)
...
animation_mode = make_widget(widgets.Dropdown(
...
prompt_salad = make_widget( widgets.Checkbox(
    value=False,
    indent=False,
), 'prompt_salad', True)

prompt_salad_amount = make_widget(widgets.IntText(
    value=5,
), "prompt_salad_amount")

prompt_salad_template = make_widget(widgets.Textarea(
    value="{colors} {things} in the {custom/customword} shape of {shapes}, art by {artists}",
      layout=widgets.Layout(width='600px')
), "prompt_salad_template")

fuzzy_prompt = make_widget(widgets.Checkbox(
    value=False,
    indent=False,
), "fuzzy_prompt", True)

heightInput = widgets.BoundedIntText(
    value=768,
    min=100,
    max=10000,
    step=1,
...
widthInput = widgets.BoundedIntText(
    value=1280,
    min=100,
    max=10000,
    step=1,
...
steps = make_widget(widgets.BoundedIntText(
    value=250,
    min=1,
    max=1000,
    step=1,
...
RN50 = make_widget(widgets.Checkbox(
    value=True,
    disabled=False,
    indent=False,
...
RN101 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
RN50x64 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
RN50x16 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
RN50x4 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
ViTB16 = make_widget(widgets.Checkbox(
    value=True,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
ViTB32 = make_widget(widgets.Checkbox(
    value=True,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
ViTL14 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
ViTL14_336 = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
use_secondary_model = make_widget(widgets.Checkbox(
    value=True,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
randomize_class = make_widget(widgets.Checkbox(
    value=True,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
diffusion_model = make_widget(widgets.Dropdown(
    options=['512x512_diffusion_uncond_finetune_008100', '256x256_diffusion_uncond'],
    value='512x512_diffusion_uncond_finetune_008100',
    disabled=False,
), 'diffusion_model')

diffusion_sampling_mode = make_widget(widgets.Dropdown(
    options=['ddim', 'plms'],
    value='ddim',
    disabled=False,
), 'diffusion_sampling_mode')

clip_guidance_scale = make_widget(widgets.BoundedIntText(
    value=5000,
    min=0,
    max=30000,
    step=1,
...
symmetry_loss = make_widget(widgets.Checkbox(
    value=False,
    disabled=False,
    indent=False,
    layout=widgets.Layout(width='20px')
...
symmetry_loss_scale = make_widget(widgets.IntText(
    value=1500,
), "symmetry_loss_scale")

symmetry_switch = make_widget(widgets.IntText(
    value=80
), "symmetry_switch")

symmetry_tab = widgets.VBox([
    symmetry_loss,
    symmetry_loss_scale,
    symmetry_switch
])

cuda_device = make_widget(widgets.Text(
    value='cuda:0',
    disabled=False
), "cuda_device")

set_seed_input = widgets.Text(
    value="random_seed",
    disabled=False
)
...
model_tab = widgets.VBox([RN50, RN101, RN50x64, RN50x16, RN50x4, ViTB16, ViTB32, ViTL14, ViTL14_336, use_secondary_model, diffusion_model, diffusion_sampling_mode, randomize_class])
